...
void boardInit(void)
{
    ...
    SctMatchReloadH(SCT0, SCT_MATCH_0, 10000);
    SctMatchReloadH(SCT0, SCT_MATCH_1, 5000);
    SctSetEventStateMask(SCT0, SCT_EVENT_0_VAL, SCT_STATE_0_BIT | SCT_STATE_1_BIT);
    SctSetEventControl(SCT0, SCT_EVENT_0_VAL, SCT_EV_CTRL_COMBMODE(SCT_COMBMODE_MATCH)| SCT_EV_CTRL_MATCHSEL(SCT_MATCH_1));
